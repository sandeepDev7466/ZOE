...
public class CsoEditProfileActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {

    MyButton update, clear;
    Context context;
    Spinner sp_country, sp_state, sp_gender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_profile_cso);
        init();
    }
