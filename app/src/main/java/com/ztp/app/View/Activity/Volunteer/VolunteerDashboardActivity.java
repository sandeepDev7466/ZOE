package com.ztp.app.View.Activity.Volunteer;
...
import com.ztp.app.View.Fragment.Volunteer.Dashboard.DashboardFragment;
...
public class VolunteerDashboardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_student_new);
...
//                    Toast.makeText(MainActivity.this, "All push tokens unregistered.", Toast.LENGTH_SHORT).show();
                            ...
                            ConnectionManager.logout(new SendBird.DisconnectHandler() {
                                ...
                                public void onDisconnected() {
                                    PreferenceUtils.init(VolunteerDashboardActivity.this);
            ...
            case R.id.edit_profile:
                ...
                if(BuildConfig.FLAVOR.equalsIgnoreCase("blueprint") || BuildConfig.FLAVOR.equalsIgnoreCase("production")){
                    Intent intent1 = new Intent(context, EditProfileActivity.class);
                    startActivity(intent1);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                }
                else if(BuildConfig.FLAVOR.equalsIgnoreCase("production"))
                {
...
//                            Toast.LENGTH_SHORT, false);
                ...
                FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(VolunteerDashboardActivity.this, new OnSuccessListener<InstanceIdResult>() {
                    @Override
...
//                            Toast.LENGTH_SHORT, false);
    ...
    private void updateCurrentUserPushToken(String newToken) {
        PushUtils.registerPushTokenForCurrentUser(VolunteerDashboardActivity.this, null, newToken);
    }
}
