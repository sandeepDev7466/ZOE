...
public class UpdateEventFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null) {
            ...
            eventData = (GetEventsResponse.Event) b.getSerializable("eventData");
...
//        icon1 = BitmapDescriptorFactory.fromResource(R.drawable.ic_beautician);
    ...
    private void submit() {
        ...
        addEventViewModel.getAddEventResponse(eventAddRequest).observe((LifecycleOwner) context, registerResponse -> {
            ...
            if (registerResponse != null && registerResponse.getResStatus().equalsIgnoreCase("200")) {
                ...
                myToast.show(getString(R.string.failed), Toast.LENGTH_SHORT, true);
                myProgressDialog.dismiss();
    ...
    public void updateData() {
        ...
        eventUpdateRequest.setEvent_image("");
    ...
    public void setEventType(GetEventsResponse.Event eventData) {
