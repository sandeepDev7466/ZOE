...
public class VolunteerRegisterActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    private void init() {
        ...
        {
            type = Constants.user_type_volunteer;
            schoolLayout.setVisibility(View.GONE);
        }
            ...
            case R.id.register:
                ...
                if (type.equalsIgnoreCase(Constants.user_type_student)) {
                    if (school_id != null && !school_id.isEmpty()) {
                        sharedPref.setUserType(Constants.user_type_student);
                        checkStudentVal();
                    ...
                    sharedPref.setUserType(Constants.user_type_volunteer);
                    checkStudentVal();
                }
...
//        }
        ...
        if (etPassword.getText().toString().equalsIgnoreCase(etConfirmPassword.getText().toString())) {
            if (!error) {
                ...
                else if (type.equalsIgnoreCase(Constants.user_type_volunteer))
                ...
                if (gender_id.isEmpty())
                    studentRegisterRequest.setUserGender("");
                else
