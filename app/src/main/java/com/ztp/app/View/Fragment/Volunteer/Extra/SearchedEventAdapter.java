...
public class SearchedEventAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(!searchedEvent.getEventStartTime().isEmpty() && !searchedEvent.getEventEndTime().isEmpty())
            holder.time.setText(context.getString(R.string.event_time)+" : "+Utility.getTimeAmPm(searchedEvent.getEventStartTime()) + " - " + Utility.getTimeAmPm(searchedEvent.getEventEndTime()));
        else
