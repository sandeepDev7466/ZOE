...
class MyBookingAdapter extends BaseAdapter {
    ...
    List<VolunteerAllResponse.VolunteerResponse> dataList;
    MyToast myToast;
    //    int status = 0;
    ...
    public MyBookingAdapter(Context context, List<VolunteerAllResponse.VolunteerResponse> dataList) {
    ...
    @Override
    public VolunteerAllResponse.VolunteerResponse getItem(int position) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        VolunteerAllResponse.VolunteerResponse data = getItem(position);
        if (view == null) {
...
//            status = 8;
    ...
    private void refreshStatus(int position, int status) {
        VolunteerAllResponse.VolunteerResponse data = dataList.get(position);
