...
public class SearchEventByAreaAdapter extends BaseAdapter {
    Context context;
    List<SearchEventbyAreaResponse.SearchedEventByArea> searchEventList;

    public SearchEventByAreaAdapter(Context context, List<SearchEventbyAreaResponse.SearchedEventByArea> searchEventList) {
    ...
    @Override
    public SearchEventbyAreaResponse.SearchedEventByArea getItem(int position) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        SearchEventbyAreaResponse.SearchedEventByArea searchedEvent = getItem(position);
        if (view == null) {
        ...
        Date date = Utility.convertStringToDateWithoutTime(searchedEvent.getEventRegisterStartDate());
