...
public class SearchEventbyAreaResponse {
    ...
    @Expose
    private List<SearchedEventByArea> searchedEvents = null;
    ...
    public List<SearchedEventByArea> getSearchedEvents() {
        return searchedEvents;
    }

    public void setSearchedEvents(List<SearchedEventByArea> searchedEvents) {
    ...
    public static class SearchedEventByArea {
