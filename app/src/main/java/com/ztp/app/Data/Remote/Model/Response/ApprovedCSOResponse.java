...
public class ApprovedCSOResponse {
    ...
    @Expose
    private List<ApprovedCSO> resData = null;
    ...
    public List<ApprovedCSO> getResData() {
        return resData;
    }

    public void setResData(List<ApprovedCSO> resData) {
