...
public class ChangeVolunteerStatusRequest {
    ...
    public ChangeVolunteerStatusRequest() {
    }

    public ChangeVolunteerStatusRequest(String user_id, String user_type, String user_device, String map_id, String map_status) {
        super();
