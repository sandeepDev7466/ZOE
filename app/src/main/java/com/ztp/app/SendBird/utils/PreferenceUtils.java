...
public class PreferenceUtils {
    ...
    private static SharedPreferences getSharedPreferences() {
        SharedPref pref = SharedPref.getInstance(mAppContext);
        return mAppContext.getSharedPreferences("Ztp", Context.MODE_PRIVATE);
    }
...
//    }
    ...
    public static String getUserId() {
        SharedPref sharedPref = SharedPref.getInstance(mAppContext);
//        setUserId(sharedPref.getEmail());
